"""
Module for programming exercises week 10.
"""
...
def plot_grad(model):
    """
    Plot histogram of gradients for the weights in each layer of model.
    """
    ...
    # quantiles = [.25, .75]
    # ax.violinplot(grad_data, quantiles=quantiles, showextrema=False)
